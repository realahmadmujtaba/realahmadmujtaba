...
Full-stack developer in Lahore, Pakistan. I build web apps with Next.js and the MERN stack, backend services with Python and FastAPI on SQL/NoSQL databases, and AI agents with the OpenAI Agents SDK, Chainlit, and Claude Code.
...
| [ai-agents-lab](https://github.com/realahmadmujtaba/ai-agents-lab) | AI agent experiments: OpenAI Agents SDK, Chainlit chatbots with tool calling, and Claude Code skills | Python, OpenAI Agents SDK, Chainlit |
...
| [react-practice](https://github.com/realahmadmujtaba/react-practice) | React practice builds: state, props, lists, and a todo app | React, Vite |
...
| AI | OpenAI Agents SDK, Chainlit, Claude Code |
